...
import { CheckCircleIcon, MapIcon, UserPlusIcon } from "lucide-react";
        ...
        <section>
          ...
          {loadingUsers ? (
            ...
            <div className="card bg-base-200 p-6 text-center">
              <h3 className="font font-semibold text-lg mb-2">
                No recommedations available
              </h3>
